...
# r"donwload\mk03_lista_cancelamento_%d_%m_%Y.xlsx"
arquivo_log = datetime.now().strftime(r"logs\MK03_%d_%m_%Y.log")
...
class Bot_Cancelamento_MK03():
    ...
    def __init__(self, usuario):
        ...
        self.page.goto("https://mk03.online.net.br/mk/")
        # -- REALIZA O LOGIN
        sleep(4)
    ...
    def Cancelar_Contrato(self, tipo_da_os, relato_do_problema, Contrato,
        ...
        # Clica no painel do cliente
        self.page.mouse.move(80, 300)
        sleep(2)
        self.page.mouse.wheel(0, 1000)
        sleep(2)
        self.__Mover_e_clicar(80, 425)
...
class Bot_Recolhimento_45d_MK03():
    ...
    def GerarOS(self, documento, conexao, tipo_os, grupo_atendimento, relato_problema):
        ...
        self.page.goto("https://mk03.online.net.br/mk/login/?sys=MK0")
        sleep(4)
    ...
    if os.path.exists(arquivo_cancelamentos):
        ...
        for index, info_os in Lista_user.iterrows():
            if index >= 0:
                ...
                print("")
                BotMK03 = Bot_Cancelamento_MK03(usuario)
                try:
                    BotMK03.Cancelar_Contrato(tipo_da_os, relato_do_problema, Contrato,
                    ...
                    logging.info(
                        f"MK03 {usuario} | index: {index} FEITO CONTRATO: {Contrato} | CODPESSOA: {CodPessoa}  \o/")
                finally:
                    BotMK03.Fecha_Navegador()
                    logging.error(
                        f"MK03 {usuario} | index: {index} FEITO CONTRATO: {Contrato} | CODPESSOA: {CodPessoa}  :/")
    ...
    if os.path.exists(arquivo_recolhimento):
        ...
        for index, info_os in Lista_user.iterrows():
            ...
            if index >= 0:
                ...
                relato_problema = info_os['Detalhe OS']
                ...
                Bot_MK01_Recolhimento = Bot_Recolhimento_45d_MK03(usuario)
                try:
...
def main(args):
    ...
    # ok
    Cancelamento(
        usuario, f'limpos/mk03_lista_cancelamento_90_dias_{DIA}_{MES}_{ANO}_limpo.csv')

    Recolhimento(
        usuario, f"limpos/mk03_recolhimento45d_{DIA}_{MES}_{ANO}_limpo.csv")
